...
uplink-autosurgeon-statveka-sandevistan-name = Автохирург: Сандевистан "Статвека"
uplink-autosurgeon-statveka-sandevistan-desc = Заменяет сердце пользователя на Сандевистан «Статвека» — синтетический орган, который значительно увеличивает скорость и рефлексы ценой выносливости. В отличие от обычного аналога, этот, судя по всему, замедляет время вокруг пользователя. Поставляется в комплекте с одноразовым автохирургом для установки.
