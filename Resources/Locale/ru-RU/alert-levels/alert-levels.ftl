...
alert-level-honk-announcement = На станции орудует коварный клоун, который нанесёт катастрофический урон, если его не казнить! Всем членам экипажа необходимо сообща казнить клоуна, если это возможно, либо эвакуироваться.
alert-level-honk-instructions = Членам экипажа рекомендуется казнить клоуна.

alert-level-amber = Янтарный
alert-level-amber-announcement = Существует угроза немедленного прекращения работы станции. Все члены экипажа должны быть вооружены любым способом, а весь второстепенный персонал должен помогать службе безопасности и руководителям персонала в обороне станции.
alert-level-amber-instructions = Члены экипажа должны быть вооружены для борьбы с угрозой уничтожения станции.
