...
contraband-examine-text-Clown = [color=yellow]Этот предмет принадлежит клоуну, верните его, пока он не загрустил.[/color]
...
contraband-examine-text-in-the-clear = [color=green][italic]Вы можете спокойно носить этот предмет на виду.[/italic][/color]
