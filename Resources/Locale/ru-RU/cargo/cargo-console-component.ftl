...
cargo-console-menu-flavor-left = Закажи ещё больше коробок пиццы, чем обычно!
...
cargo-console-menu-populate-orders-cargo-order-row-product-name-text = Запросил: { $orderRequester } из [color={ $accountColor }]{ $account }[/color]
...
cargo-console-fund-withdraw-broadcast = [bold]{ $name } снял { $amount } spesos с { $name1 } \[{ $code1 }\][/bold]
cargo-console-fund-transfer-broadcast = [bold]{ $name } перевёл { $amount } spesos с { $name1 } \[{ $code1 }\] на { $name2 } \[{ $code2 }\][/bold]
...
cargo-console-cooldown-active = Заказы на { $product } не могут быть размещены ещё { $timeCount } { $timeUnits }.
