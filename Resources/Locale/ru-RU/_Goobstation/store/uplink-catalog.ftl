...
uplink-carpcaller-name = Приманка для космических карпов
uplink-carpcaller-desc = Устройство, использующее психологию карпов. Если закрепить его, запитать и оставить под открытым космосом, оно привлечёт диких космических карпов. Учтите: вы им не друг.
...
uplink-autosurgeon-statveka-sandevistan-desc = Заменяет сердце пользователя на "статвека-сандевистан", синтетический орган, резко повышающий скорость и рефлексы ценой выносливости. В отличие от обычной версии, этот имплант будто замедляет время рядом с пользователем. Поставляется с одноразовым автохирургом для установки.
...
uplink-bloodred-cassette-desc = Портативный музыкальный плеер, предоставленный самыми эгоистичными модельерами Киберсан!
